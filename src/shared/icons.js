const icons = {
  ...
  publication:'<path d="M6 3h9l3 3v15H6z"/><path d="M15 3v4h4M9 11h6M9 15h6"/>',
  draft:'<path d="M5 4h10l4 4v12H5z"/><path d="M15 4v5h5M8 16l6-6 2 2-6 6H8z"/>',
  collection:'<rect x="4" y="4" width="12" height="14" rx="2"/><path d="M8 2h10a2 2 0 0 1 2 2v12"/>',
  following:'<path d="M7 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM1 21a6 6 0 0 1 12 0"/><path d="m15 12 2 2 4-5"/>',
